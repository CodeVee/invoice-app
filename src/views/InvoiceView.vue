<template>
    <div v-if="state.invoice" >
        <invoice-mobile-form v-if="state.showForm" :invoice="state.invoice" @cancel="closeMobileForm"/>
        <div v-else class="relative md:w-[68.8rem] mx-auto px-2.4 md:px-0 pt-3.2 md:pt-4.8 lg:pt-[6.4rem] lg:pb-[5.4rem] lg:w-full lg:mx-0">
            ...
            <div class="flex items-center justify-between px-2.4 -mx-2.4 md:hidden  bg-white dark:bg-blue-vdark h-36 mt-5.6">
