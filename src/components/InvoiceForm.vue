        ...
        <form @submit.prevent="">        
            ...
            <div>
                ...
                <div class="grid grid-cols-[21.4rem_4.6rem_5.6rem_auto] gap-x-1.6 my-1.6">
                    <span class="text-blue-gray text-fl font-medium">Item Name</span>
                    <span class="text-blue-gray text-fl font-medium">Qty.</span>
                    <span class="text-blue-gray text-fl font-medium">Price</span>
                    <span class="text-blue-gray text-fl font-medium">Total</span>
                </div>
                <div class="flex flex-col gap-[1.8rem] mb-16">
                    <div v-for="item in items" :key="item" class="grid grid-cols-[21.4rem_4.6rem_5.6rem_1fr_auto] gap-x-1.6 items-center">
                        ...
                        <text-box />
                        <text-box />
                        <span class="text-blue-vgray text-fl font-bold">{{formatAmount(item)}}</span>
                        <button>
